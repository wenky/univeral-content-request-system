...
// shameless ripped from codehaus...
...
* <li><tt>"binding"</tt> : (added by CEM)back-reference to the instance of this class</li>
* </ul>
* 
* <p>
...
public class ServletBinding extends Binding {
   ...
   public ServletBinding(HttpServletRequest request, HttpServletResponse response, ServletContext context) {
       ...
       // can't do this since some invoker.format() command tries to serialize it.
       binding.setVariable("binding", this.getVariables()); // <-- back-ref added by CEM
