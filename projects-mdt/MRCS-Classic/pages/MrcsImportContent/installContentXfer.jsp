...
***********************************************************************
 ...
 Filename       $RCSfile: installContentXfer.jsp,v $
...
int in=url.indexOf("checkApplet");
if (in != -1)
{
realUrl=url.substring(0,in)+"installContentXfer"+url.substring(in+11);
}
else
{
realUrl = url;
...
String strArchivePath_os9 = IContentXferConstants.DEFAULT_CODEBASE_URL + "mac_contentxfer.jar";
String strArchivePath_osx = IContentXferConstants.DEFAULT_CODEBASE_URL + "mac_contentxfer_osx.jar";
String strArchivePath_Jar = IContentXferConstants.DEFAULT_CODEBASE_URL + "ContentXfer.jar";
...
String strContentXferCabFileInstall = s_lookup.getString("MSG_INSTALLING_PLEASE_WAIT", argsArray, LocaleService.getLocale());
//
%>
<dmf:html>
<dmf:head>
<dmf:title><dmf:label nlsid='MSG_INSTALL_CONTENT_TRANSFER_APPLETS'/></dmf:title>
...
if(isMac)
{
alert('<%=form.getString("MSG_INSTALL_SUCCESS_MESSAGE")%>');
postServerEvent(null, null, null, "onInstallComplete");
}
else
{
...
if ( bIsIE == true )
{
var strInstalled = document.installationApplet.SUCCESS_MESSAGE;
if ( typeof(strInstalled) == "undefined" )
{
postServerEvent(null, null, null, "onInstallComplete");
}
else
...
<tr>
<td class='heading' align='center'>
<dmf:label nlsid='MSG_WONT_WORK_WITHOUT_APPLETS'/>
<br><br>
</td>
</tr>
<tr>
...
<param name='useslibrary' value='<%=IContentXferConstants.APPLET_LIB_NAME%>'>
<param name='useslibrarycodebase' value='ContentXfer.cab'>
