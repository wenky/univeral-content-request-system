...
***********************************************************************
 ...
 Filename       $RCSfile: serviceProgress.jsp,v $
...
<dmf:head>
    ...
    <script>
function contentTransferServiceComplete()
{
postServerEvent(null, null, null, "onContentTransferServiceComplete");
}
</script>
</dmf:head>
<dmf:body cssclass='contentBackground' marginheight='0' marginwidth='12'
    ...
    <dmf:form>
        ...
        <table align="center">
            ...
            <tr>
                <td><script language="JavaScript">writeProgressBar()</script></td>
            </tr>
        </table>
        <dmxfer:serviceprogressfeedback name="serviceprogressfeedback" />
    </dmf:form>
</dmf:body>
</dmf:html>
<script language="JavaScript">contentTransferServiceComplete();</script>
