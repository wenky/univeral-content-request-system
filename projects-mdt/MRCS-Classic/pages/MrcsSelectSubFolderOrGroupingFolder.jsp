...
<dmf:html>
  <dmf:head>
    ...
    <title><dmf:label nlsid='MSG_GFORSF_PAGE_TITLE'/></title>
    <title></title>
  ...
  <dmf:body>
    <dmf:label nlsid='MSG_GFORSF_TITLE'/><br>
    <dmf:form>
        <table border="0" cellpadding="2" cellspacing="0" width="200">
            <tr>
                <td>
                    <dmf:button name="createGF" onclick="createGF" nlsid="MSG_CREATE_GF" 
                                cssclass='buttonLink' height='16' imagefolder='images/dialogbutton' tooltipnlsid='MSG_NEXT_TIP'/>     
                </td>
                <td>
                    <dmf:button name="createGF" onclick="createSF" nlsid="MSG_CREATE_SF" 
                                cssclass='buttonLink' height='16' imagefolder='images/dialogbutton' tooltipnlsid='MSG_NEXT_TIP'/>     
                </td>
                <td>
