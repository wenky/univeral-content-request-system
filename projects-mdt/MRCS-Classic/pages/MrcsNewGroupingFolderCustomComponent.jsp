...
***********************************************************************
 ...
 Filename       $RCSfile: MrcsNewGroupingFolderCustomComponent.jsp,v $
...
<dmf:html>
  <dmf:head>
    ...
    <title><dmf:label nlsid='MSG_USERSPECIFIED_PAGE_TITLE'/></title>
  ...
  <dmf:body>
    <dmf:label nlsid='MSG_USERSPECIFIED_TITLE'/><br>
    <dmf:form>
      <dmf:label nlsid='MSG_USERSPECIFIED_FOLDER_NAME_LABEL'/><dmf:text name="MrcsCustomObjectName"/><br>
	    <table border="0" cellpadding="2" cellspacing="0" width="100">
	        <tr>
	            <td>
	                <dmf:button name="Submit" onclick="processCustomGroupingFolderPage" nlsid="MSG_BUTTON_NEXT" 
