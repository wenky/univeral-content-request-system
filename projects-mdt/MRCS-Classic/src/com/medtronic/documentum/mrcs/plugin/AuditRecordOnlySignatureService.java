...
public class AuditRecordOnlySignatureService implements ISignatureService
{
	...
	{
        /*-CONFIG-*/String m = "AuditRecordOnlySignatureService.sign-";
	...
	public boolean signDocument(IDfSession session, IDfDocument docObject, String username, String password, String reason) throws DfException
	{
    	...
    	try {
    		...
    		com.documentum.fc.common.IDfId auditRec = docObject.addESignature(username,password,reason,"other","","","QADocCustomSignatureMethod","","","");
