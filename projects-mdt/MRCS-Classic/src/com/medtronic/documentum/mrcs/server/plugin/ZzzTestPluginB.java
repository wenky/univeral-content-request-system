...
public class ZzzTestPluginB  implements IMrcsLifecyclePlugin 
{
	...
	public void execute(IDfSessionManager sMgr, String docbase, MrcsLifecycleState targetstate,String mrcsapp,IDfSysObject obj,Map config, Map context)
	{
		try {
			// log some info...
	        /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, " - Entry of ZzzTestPluginB : " , null,null);
			...
			throw new RuntimeException("Error in ZzzTestPluginB",dfe);
		}
