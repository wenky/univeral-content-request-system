...
<%@ page import="com.medtronic.documentum.mrcs.client.QADocForwardWFT"%>
                    ...
                    <dmf:panel name='<%=ForwardWorkflowTask.SIGNOFF_PANEL_CONTROL_NAME%>'>
                        ...
                        <tr>
                            <td>
                                ...
                                <table border="0">
                                <tr><td><dmf:label nlsid='MSG_USERNAME_FIELD_LABEL' /></td><td><dmf:text name='<%=QADocForwardWFT.USERNAME_CONTROL_NAME%>'             defaultonenter='true'  tooltipnlsid='MSG_PASSWORD_FIELD_LABEL' /></td></tr>
                                <tr><td><dmf:label nlsid='MSG_PASSWORD_FIELD_LABEL' /></td><td><dmf:password name='<%=QADocForwardWFT.PASSWORD_CONTROL_NAME%>'         defaultonenter='false' tooltipnlsid='MSG_PASSWORD_FIELD_LABEL' /></td></tr>
                                <tr><td><dmf:label nlsid='MSG_REASON_FIELD_LABEL'   /></td><td><dmf:dropdownlist name='<%=QADocForwardWFT.REASONSELECT_CONTROL_NAME%>' tooltipnlsid='MSG_REASON_FIELD_LABEL'   /></td></tr>
                                </table>
