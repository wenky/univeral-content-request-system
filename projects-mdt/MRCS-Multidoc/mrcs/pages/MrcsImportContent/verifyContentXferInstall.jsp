...
***********************************************************************
 ...
 Filename       $RCSfile: verifyContentXferInstall.jsp,v $
...
{
checkLightInstall("<%=form.getString("MSG_INSTALL_SUCCESS_MESSAGE")%>","<%=form.getString("MSG_INSTALL_FAILURE_MESSAGE")%>");
postServerEvent(null, null, null, "onVerifyInstallComplete");
}
</script>
</dmf:head>
