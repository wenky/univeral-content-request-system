...
***********************************************************************
 ...
 Filename       $RCSfile: checkFullApplet.jsp,v $
...
function finish()
{
var bInstalled = checkContentXferAppletInstall("<%=IContentXferConstants.VERSION_NUMBER%>", true);
if (bInstalled == true)
{
postServerEvent(null, null, null, "onCheckFullAppletComplete");
}
else
{
postServerEvent(null, null, null, "onNeedFullInstall");
}
}
</script>
</dmf:head>
