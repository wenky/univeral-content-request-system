...
***********************************************************************
 ...
 Filename       $RCSfile: MrcsTaskAttachmentDrilldown.jsp,v $
...
<tr><td>
<dmf:datagrid name='<%=TaskAttachment.ATTACHMENT_GRID_CONTROL_NAME%>' paged='true' pagesize='5'
...
-->
<dmfx:actionlinklist name='<%=TaskAttachment.ACTIONLIST_CONTROL_NAME%>' cssclass='actions' >
<dmf:argument name='objectId' datafield='r_object_id'/>
<dmf:argument name='contentType' datafield='a_content_type'/>
<dmf:argument name='type' datafield='r_object_type'/>
<dmf:argument name='lockOwner' datafield='r_lock_owner'/>
...
<dmf:link onclick='onNewFormAttachment' datafield='useFormName' cssclass='actions' name='<%=TaskAttachment.NEW_FORM_LINK_CONTROL_NAME%>'>
<dmfx:argument name='objectId' contextvalue='queueItemId'/>
<dmf:argument name='packageName' datafield='packageName'/>
<dmf:argument name='type' value='dmi_package'/>
<dmf:argument name='formTemplateId' datafield='formTemplateId'/>
...
%>
<td valign='top' align='right'>
<dmfx:actionlink cssclass='actions' name='addattachactnlnk2' nlsid='MSG_ADD_ATTACHMENT' action='addattachment' showifdisabled='false'>
<dmfx:argument name='objectId' contextvalue='queueItemId'/>
<dmf:argument name='packageName' datafield='packageName'/>
<dmf:argument name='type' value='dmi_package'/>
<dmf:argument name='formTemplateId' datafield='formTemplateId'/>
