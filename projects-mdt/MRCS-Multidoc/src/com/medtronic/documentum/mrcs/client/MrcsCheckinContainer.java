...
public class MrcsCheckinContainer extends CheckinContainer {
    ...
    public void finished(Form form, Map map, JobAdapter job)
    {
        ...
        try { 
            ...
            try { 
                /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+"get previous version so we can persist log_entry", null, null);
            	IDfDocument prevdoc = (IDfDocument)getDfSession().getObject(newdoc.getAntecedentId());
                /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+"setting current logentry to previous logentry: "+prevdoc.getString("log_entry"), null, null);
            	newdoc.setString("log_entry",prevdoc.getString("log_entry"));
                /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+"saving logentry", null, null);
            	newdoc.save();
                /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+"logentry saved", null, null);
            } catch (NullPointerException npe) {
                /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+"NPE in getting/setting logentry: no previous version?", null, null);            	
            }
