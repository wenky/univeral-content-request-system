...
public class AttachAllVersionsToState extends SuspendPreviousVersion implements IMrcsLifecyclePlugin {
    ...
    {
        /*-CFG-*/String m = "AttachAllVersionsToState.getDQL()-";
    ...
    public void process(IDfCollection match, IDfSessionManager sMgr, String docbase, String mrcsapp, IDfSysObject mrcsdocument, Map configdata, Map customdata) throws Exception
    {
        ...
        /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, m+"- configured state to attach to: "+state, null, null);        
        ...
        try { 
            ...
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, m+"getting current lifecycle id", null, null);
            IDfId lifecycle = doc.getPolicyId();
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, m+"forcing simple promote", null, null);
            doc.detachPolicy();
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, m+"attach to state of lifecycle "+lifecycle.getId(), null, null);
            doc.attachPolicy(lifecycle, state, "");
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, m+"simple promote complete", null, null);
    
            // PURGE CURRENT from labels
