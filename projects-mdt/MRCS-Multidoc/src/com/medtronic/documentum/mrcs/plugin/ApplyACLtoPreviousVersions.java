...
public class ApplyACLtoPreviousVersions extends ThereCanOnlyBeOne {
    ...
    {
        /*-CFG-*/String m = "ApplyACLtoPreviousVersions.getDQL()-";
    ...
    // apply the specified ACL to all matches
    ...
    {
        /*-CFG-*/String m = "ApplyACLtoPreviousVersions.process()-";
        /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, m+"reacquire session", null, null);
        IDfSession session = sMgr.getSession(docbase);
