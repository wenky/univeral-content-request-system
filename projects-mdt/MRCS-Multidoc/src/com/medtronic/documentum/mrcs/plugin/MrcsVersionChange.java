...
public class MrcsVersionChange extends MrcsBasePlugin implements IVersionChangePlugin {    
    ...
    public IDfId performVersionChange(IDfSessionManager sMgr, String mrcsapp, Map params) throws DfException 
    {
        ...
        try {
            ...
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, "MrcsVersionChange:performVersionChange : get current log_entry", null, null);
            String logentry = docObject.getString("log_entry");
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, "MrcsVersionChange:performVersionChange : - logentry: "+logentry, null, null);
            ...
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, "MrcsVersionChange:performVersionChange : get new doc so we can preserve the logentry", null, null);
            IDfSysObject newdoc = (IDfSysObject)docObject.getSession().getObject(_newObjId);
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, "MrcsVersionChange:performVersionChange : setting logentry", null, null);
            newdoc.setString("log_entry",logentry);
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, "MrcsVersionChange:performVersionChange : saving", null, null);
            newdoc.save();
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, "MrcsVersionChange:performVersionChange : saved", null, null);
