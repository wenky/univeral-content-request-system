...
public class MdtSendMail  implements IMdtWorkflowAction
{
    public void execute(IDfSessionManager sessionmgr, String docbase, String mdtapp, IDfSysObject formobj, List attachments, IDfWorkitem workitem, Map methodparameters, Map plugincfg)
    {
        ...
        try {
            ...
            Object recipiententityobj = plugincfg.get("Recipients");
            MailUtils.addEntityOrListOfEntitiesToAddressSet(session,recipiententityobj,addresses);
