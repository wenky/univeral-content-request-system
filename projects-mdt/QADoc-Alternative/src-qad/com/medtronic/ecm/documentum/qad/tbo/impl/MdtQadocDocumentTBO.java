package com.medtronic.ecm.documentum.qad.tbo.impl;
...
import com.medtronic.ecm.documentum.qad.tbo.IMdtQadocDocumentTBO;
import com.medtronic.ecm.util.CollUtils;

public class MdtQadocDocumentTBO extends MdtBaseDocumentTBO implements IMdtQadocDocumentTBO
{    
    public void attachLifecycle() throws DfException
    {
        ...
        // lookup LifecycleName from config for given doctype from appconfig
        ...
        // lookup optional alias set to attach along with the lifecycle from appconfig
    ...
    public void doAttachPolicy(IDfId policyId, String stateNameOrIndex,
            String scope, Object[] extendedArgs) throws DfException {
        // TODO Auto-generated method stub
        super.doAttachPolicy(policyId, stateNameOrIndex, scope, extendedArgs);
    }

    public IDfId doCheckin(boolean retainLock, String versionLabels,
            String oldCompoundArchValue, String oldSpecialAppValue,
            String newCompoundArchValue, String newSpecialAppValue,
            Object[] extendedArgs) throws DfException {
        // TODO Auto-generated method stub
        return super.doCheckin(retainLock, versionLabels, oldCompoundArchValue,
                oldSpecialAppValue, newCompoundArchValue, newSpecialAppValue,
                extendedArgs);
    }
    ...
    public void doSave(boolean saveLock, String versionLabel, Object[] args)
            throws DfException {
        // TODO Auto-generated method stub
    ...
    public IDfId doSaveAsNew(boolean shareContent, boolean copyRelations,
            Object[] extendedArgs) throws DfException {
        // TODO Auto-generated method stub
...
//          IMdtNaming namer = (IMdtNaming)Class.forName(curplugin.classname).newInstance();
            /*-trc-*/if(Lg.trc())start[i]=(new Date()).getTime();           
            Object sboobj = MdtPluginLoader.loadPlugin(curplugin,session.getSessionManager());
            /*-trc-*/if(Lg.trc()){Class[] ifaces = sboobj.getClass().getInterfaces();Class c = IMdtDocumentNaming.class;Lg.trc("iface class: %d casting class: %d equals? %s",ifaces[0],IMdtDocumentNaming.class,ifaces[0]==IMdtDocumentNaming.class);}
...
//      setString(MDT_SYSTEMNAME_ATTR_NAME,name);       
    ...
    public String getVendorString() {return "Medtronic-QADOC";}    
