...
<%@ page import="com.medtronic.ecm.documentum.mdtworkflow.webtop.MdtFormDocumentsSelection"%>
...
<dmf:body cssclass='contentBackground' marginheight='0' marginwidth='0' topmargin='0' bottommargin='0' leftmargin='0' rightmargin='0'>
  <dmf:form>
    ...
    <dmfx:actionmultiselect name='multiselect'>
      ...
      <dmf:datagrid name='<%=MdtFormDocumentsSelection.GRID_NAME%>' paged='true' preservesort='false' cssclass='contentBackground' width='100%' cellspacing='0' cellpadding='0' bordersize='0' fixedheaders="true" focus="true">
        <%
            MdtFormDocumentsSelection form = (MdtFormDocumentsSelection) pageContext.getAttribute(Form.FORM,PageContext.REQUEST_SCOPE);
            DataProvider dataProvider = ((Datagrid) form.getControl(MdtFormDocumentsSelection.GRID_NAME,Datagrid.class)).getDataProvider();
        %>
