...
public class LSPluginLoader 
{
    ...
    {        
        try { 
            ...
            throw EEx.create("LSPluginLoader-NotFound", "Instantiation of plugin failed - class %s not located", classname,cnfe);            
            ...
            throw EEx.create("LSPluginLoader-NoAccess", "Access Exception - instantiation of plugin %s not allowed by JAAS or private/protected rules", classname,sece);                        
            ...
            throw EEx.create("LSPluginLoader-CannotCreate", "Instantiation Error - instantiation of plugin %s not allowed, probably due to it being an interface or an abstract class", classname,ie);                                    
        }
    }

    public static Object loadPlugin(LSPlugin plugin, Object...args)
    {
        try { 
            ...
            throw EEx.create("LSPluginLoader-NotFound", "Instantiation of plugin failed - class %s not located", plugin.Class,cnfe);            
        } catch (IllegalAccessException sece) {
            /*-ERROR-*/Lg.err("Access Exception - instantiation of plugin %s not allowed by JAAS or private/protected rules", plugin.Class,sece);
            throw EEx.create("LSPluginLoader-NoAccess", "Access Exception - instantiation of plugin %s not allowed by JAAS or private/protected rules", plugin.Class,sece);                        
        } catch (InstantiationException ie) {
            ...
            throw EEx.create("LSPluginLoader-CannotCreate", "Instantiation Error - instantiation of plugin %s not allowed, probably due to it being an interface or an abstract class", plugin.Class,ie);                                    
        }
