 // eliminate resizing to see if performance is markedly better....
    ...
    this.GenerateDataTableDiv = function() 
    {
        ...
        for (var d=0; d < this.data.results.length; d++)
        {
          ...
          for (var dc =0; dc < this.data.columns.length; dc++)
          {
            if (this.data.columns[dc].hidden != true) {
              ...
              datarow += "<td nowrap>" + this.data.results[d][this.data.columns[dc].name] + "</td>";
            }
          }
          datarow += "</tr>";
          table += datarow;
        ...
        for (var c=0; c < this.data.columns.length; c++)
        {
          if (this.data.columns[c].hidden != true) {
            columnheaders += "<th nowrap>"+this.data.columns[c].name+"<img src='./wdk/theme/documentum/icons/sort/sortDown.gif' onclick='"+this.varname+".SortByColumn(\""+this.data.columns[c].name+"\");'></th>";
          }
        }
