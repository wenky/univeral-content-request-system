...
<%@ page import="com.medtronic.ecm.documentum.mdtworkflow.webtop.MdtFinishTask"%>
          ...
          <dmf:panel name='<%=FinishWorkflowTask.SIGNOFF_PANEL_CONTROL_NAME%>'>
            ...
            <tr>
              <td>
                ...
                <table border="0">
                <tr><td><dmf:label nlsid='MSG_USERNAME_FIELD_LABEL' /></td><td><dmf:text name='<%=MdtFinishTask.USERNAME_CONTROL_NAME%>'             defaultonenter='true'  tooltipnlsid='MSG_PASSWORD_FIELD_LABEL' /></td></tr>
                <tr><td><dmf:label nlsid='MSG_PASSWORD_FIELD_LABEL' /></td><td><dmf:password name='<%=MdtFinishTask.PASSWORD_CONTROL_NAME%>'         defaultonenter='false' tooltipnlsid='MSG_PASSWORD_FIELD_LABEL' /></td></tr>
                <tr><td><dmf:label nlsid='MSG_REASON_FIELD_LABEL'   /></td><td><dmf:dropdownlist name='<%=MdtFinishTask.REASONSELECT_CONTROL_NAME%>' tooltipnlsid='MSG_REASON_FIELD_LABEL'/><dmf:text name='<%=MdtFinishTask.REASONENTRY_CONTROL_NAME%>' tooltipnlsid='MSG_REASON_FIELD_LABEL'/></td></tr>
                </table>
