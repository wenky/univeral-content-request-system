...
<!-- CEM: new approval form commands (w/multiselect and without)  NOTE: remember to "touch" mdt_menubar.jsp include -->
<dmfx:actionmenuitem dynamic="genericnoselect" name="file_mdtnewchangerequest_nodocs" nlsid='MSG_NEW_APPROVAL_FORM_NODOCS' action="mdtnewchangerequest_nodocs_action" showifinvalid="false" showifdisabled="false"/>
<dmfx:actionmenuitem dynamic="multiselect" name="file_mdtnewchangerequest" nlsid='MSG_NEW_APPROVAL_FORM' action="mdtnewchangerequestaction" showifinvalid="false" showifdisabled="false"/>
...
<!-- CEM: disable these, add start approval command (AND REASSIGN)-->
<dmfx:actionmenuitem dynamic='singleselect' name='file_mdtformstartworkflow' nlsid='MSG_START_APPROVAL' action="mdtformstartworkflowaction" showifinvalid="true" showifdisabled="true"/>
<dmfx:actionmenuitem dynamic='genericnoselect' name='tools_reassigntask' nlsid='MSG_QADOC_REASSIGN' action="mdtReassignTaskContainer" showifinvalid="true" showifdisabled="true"/>
<dmfx:actionmenuitem dynamic='singleselect' name='tools_releaseimmediately' nlsid='MSG_QADOC_RELEASE_IMMEDIATELY' action="smoreleaseimmediately" showifinvalid="true" showifdisabled="true"/>
