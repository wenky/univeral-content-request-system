...
<%@ page import="com.medtronic.ecm.documentum.mdtworkflow.webtop.MdtFormSupportingDocuments"%>
...
<dmf:body cssclass='contentBackground' marginheight='0' marginwidth='0' topmargin='0' bottommargin='0' leftmargin='0' rightmargin='0'>
  <dmf:form>
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                ...
                <dmf:button name='addSupporting' nlsid='MSG_ADD_DOCUMENT_BUTTON' onclick='onCompleteAddDocument'/>
            </td>
        </tr>
        <tr>
            <td colspan="3" height="7" class="spacer">
    ...
    <dmfx:actionmultiselect name='multiselect'>
      ...
      <dmf:datagrid name='<%=MdtFormSupportingDocuments.GRID_NAME%>' rowselection='false' paged='true' preservesort='false' cssclass='contentBackground' width='100%' cellspacing='0' cellpadding='0' bordersize='0' fixedheaders="true" focus="true">
        <%
            MdtFormSupportingDocuments form = (MdtFormSupportingDocuments) pageContext.getAttribute(Form.FORM,PageContext.REQUEST_SCOPE);
            DataProvider dataProvider = ((Datagrid) form.getControl(MdtFormSupportingDocuments.GRID_NAME,Datagrid.class)).getDataProvider();
        %>
