...
public class PulseLockCheckin extends UcfCheckin //Checkin
{
    ...
    protected Radio getSameVersionRadioControl525(boolean ignore) {
        Radio _radioSameVersion = (Radio) getControl("sameversion", com.documentum.web.form.control.Radio.class);
    	return _radioSameVersion;
    }

    protected Label getSameVersionLabelControl525(boolean ignore) {
        Label _labelSameVersion = new Label();
    	return _labelSameVersion;
    }
