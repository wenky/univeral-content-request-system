...
***********************************************************************
 ...
 Filename       $RCSfile: NPPWorkflowTemplateLocator.java,v $
 ...
 */
public class NPPWorkflowTemplateLocator extends MrcsWorkflowTemplateLocator {
    ...
    public void onInit(ArgumentList argumentlist) {
        ...
        try {
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, "MRCS:NPPWorkflowTemplateLocator.onInit - instantiate the document.", null, null);
            docObject = (IDfDocument) getDfSession().getObject(new DfId(val[0]));

            super.onInit(argumentlist);
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, "MRCS:NPPWorkflowTemplateLocator.onInit - Query Statement: "+ getQueryStatement(), null, null);
        } catch (DfException dfe) {
            /*-DEBUG-*/if (DfLogger.isErrorEnabled(this))DfLogger.error(this, "MRCS:NPPWorkflowTemplateLocator.onInit - exception caught: " + dfe, null, null);
    ...
    protected LocatorQuery createQuery() {
        ...
        NPPWorkflowTemplateLocatorQuery mrcsworkflowtemplatelocatorquery = null;
        try {
            mrcsworkflowtemplatelocatorquery = new NPPWorkflowTemplateLocatorQuery();
            ...
            mrcsworkflowtemplatelocatorquery.setStateForWFfetch(((IDfDocument) docObject).getCurrentStateName());
        } catch (DfException dfe) {
            /*-DEBUG-*/if (DfLogger.isErrorEnabled(this))DfLogger.error(this, "MRCS:NPPWorkflowTemplateLocator.createQuery : Exception caught: "+ dfe, null, null);
            throw new WrapperRuntimeException(dfe);
        } finally {
     ...
     *
     */
    public NPPWorkflowTemplateLocator() {
        super();
    }
