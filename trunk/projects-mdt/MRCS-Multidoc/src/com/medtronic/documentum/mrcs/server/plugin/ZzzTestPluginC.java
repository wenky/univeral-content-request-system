...
public class ZzzTestPluginC  implements IMrcsLifecyclePlugin 
{
	...
	public void execute(IDfSessionManager sMgr, String docbase, MrcsLifecycleState targetstate,String mrcsapp,IDfSysObject obj,Map config, Map context)
	{
		try {
			// log some info...
	        /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this, " - Entry of ZzzTestPluginC : " , null,null);
			...
			throw new RuntimeException("Error in ZzzTestPluginC",dfe);
		}
