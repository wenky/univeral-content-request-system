...
<html>
  ...
  <body>
    MRCS New Grouping Folder JSP...<br>
    <dmf:form>
      Folder Name: <dmf:text name="MrcsCustomFolderName"/><br>
      Mrcs Comment: <dmf:text name="MrcsCustomMrcsComment"/><br>
      Mrcs Reason: <dmf:text name="MrcsCustomMrcsReason"/><br>
