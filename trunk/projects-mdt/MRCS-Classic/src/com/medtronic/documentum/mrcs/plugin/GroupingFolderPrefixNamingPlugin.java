...
***********************************************************************
 ...
 Filename       $RCSfile: GroupingFolderPrefixNamingPlugin.java,v $
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class GroupingFolderPrefixNamingPlugin implements MrcsNamingFormatPlugin, MrcsDocumentNamingFormatPlugin
{
    ...
    String getGroupingFolderName(IDfSession session,String objectid) throws Exception
    {
        ...
        if (parentfolder.hasAttr("mrcs_grouping_folder_root"))
        {
            ...
            return getPrefixName(gfroot.getObjectName());
        }
        ...
        else if (parentfolder.hasAttr("mrcs_config"))
        {
            ...
            return getPrefixName(parentfolder.getObjectName());
        }
