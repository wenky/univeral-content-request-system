...
public class RejectWFT extends RejectWorkflowTask {
    ...
    private void performValidation() throws DfException {
        /*-CONFIG-*/String m="performRejectWFTaskValidation-";
        ...
        if (iworkflowtask.isSignOffRequired()) {
            ...
            // grab task info so we can also validate the maximum number of reject paths selected...
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+" getting MRCS workflow reject task info for current task", null, null);
            ...
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+" checking Reject checkbox datagrid for at-least-one-checked", null, null);
            ...
            /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+" iterating through reject datagrid controls, adding them to our set of checkboxes if they are of type checkbox", null, null);
            while (i.hasNext())
            {
                Control current = (Control)i.next();
                /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+" datagrid control: " + current.getName(), null, null);
                
                if (current instanceof DatagridRow)
                {
                	/*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+" The datagrid control: " + current.getName() + " is instance of DatagridRow", null, null);
                    ...
                    while (cboxes.hasNext())
                    {
                        ...
                        if (subcurrent instanceof Checkbox)
                        {
                        	...
                        	/*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+" The control: " + cboxname + " is instance of Checkbox", null, null);
            ...
            if (1 == boxcount)
            {
                ...
                /*-DEBUG-*/if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+"autochecking the single reject path", null, null);
        ...
        {
        	if (DfLogger.isDebugEnabled(this))DfLogger.debug(this,m+" :No signoff is req'd", null, null);
        }
