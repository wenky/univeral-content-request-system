<%
  System.out.println("I am in what? prlcustomdoclist_body.jsp");
%>
...
<table border='0' cellpadding='0' cellspacing='0' >
  ...
  <tr><td>What's going on here?</td></tr>
</table>
</center>
...
<th scope='col' align='left' class='doclistbodyHeaderPadding'>
&nbsp;&nbsp;<b><dmf:datasortlink name='sort1' datafield='object_name' cssclass='doclistbodyDatasortlink'/></b>
</th>
</dmf:celltemplate>
<dmf:celltemplate field='authors'>
<th scope='col' align='left'>
<b><dmf:datasortlink name='sort3' datafield='authors' cssclass='doclistbodyDatasortlink'/></b>
</th>
</dmf:celltemplate>
