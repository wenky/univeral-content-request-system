...
***********************************************************************
 ...
 Filename       $RCSfile: MrcsNewSubfolderCustomComponent.jsp,v $
...
<dmf:html>
  <dmf:head>
    ...
    <title><dmf:label nlsid='MSG_USERSPECIFIEDSF_PAGE_TITLE'/></title>
  ...
  <dmf:body>
    <dmf:label nlsid='MSG_USERSPECIFIEDSF_TITLE'/><br>
    <dmf:form>
      <dmf:label nlsid='MSG_USERSPECIFIEDSF_FOLDER_NAME_LABEL'/><dmf:text name="MrcsCustomObjectName"/><br>
        <table border="0" cellpadding="2" cellspacing="0" width="100">
            <tr>
                <td>
                    <dmf:button name="Submit" onclick="processCustomSubfolderPage" nlsid="MSG_BUTTON_NEXT" 
