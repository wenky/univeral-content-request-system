...
public class RequestContext 
{
    ...
    public static void setHttpObjects(HttpServletRequest req, HttpServletResponse resp, ServletContext ctx, Map config, Context actioncontext)
    {
    ...
    {
        return (Context)localactionctx.get();
    }

    public static void setActionContext(Context ctx)
    {
