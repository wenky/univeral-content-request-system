...
import com.cem.base.interfaces.ILgObjectLogger;
 ...
 *     
 * or rely on the minidump feature in the MdtLog. 
 *     
    ...
    public static void replaceObjectsWithInfo(Object[] args)
    {
    	if (args != null)
    	{
    		for (int i=0; i < args.length; i++) 
    		{
    		    ...
    		    {
    		        ILgObjectLogger objlogger = (ILgObjectLogger)ObjectReplacements.get(j);
